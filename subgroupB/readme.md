...
Backend API
Navigate to the 5105 ml folder.
Install required dependencies:
pip install flask
pip install flask\-cors
Start the local API server:
python app.py
Ensure the best rf model.pkl file is in the same directory as app.py.
...
Generate a personalized report based on user data and emissions results.
Folder Structure
best\_rf\_model.pkl \# Machine Learning model
